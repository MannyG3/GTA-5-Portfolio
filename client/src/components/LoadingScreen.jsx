...
const LoadingScreen = () => {
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        >
          <h1 className="font-bebas text-6xl md:text-8xl tracking-tight mb-2">
            <span className="text-gta-orange" style={{ textShadow: '0 0 30px rgba(255, 179, 92, 0.5)' }}>LOS</span>
            <span className="text-gta-teal ml-3" style={{ textShadow: '0 0 30px rgba(25, 194, 199, 0.5)' }}>SANTOS</span>
          </h1>
      ...
      {/* Corner decorations - Orange/Teal */}
